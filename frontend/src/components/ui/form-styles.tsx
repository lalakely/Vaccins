...
export const formStyles = {
  ...
  input: "w-full pl-10 bg-white border-gray-200 text-gray-900 placeholder:text-gray-400 rounded-lg shadow-sm transition-all duration-200 focus:ring-2 focus:ring-gray-200 focus:border-gray-500 hover:border-gray-300 group-hover:border-gray-300",
  ...
  // Boutons
  primaryButton: "w-full bg-gradient-to-r from-gray-600 to-gray-700 text-white hover:from-gray-700 hover:to-gray-800 active:from-gray-800 active:to-gray-900 transition-all duration-200 transform hover:-translate-y-1 rounded-lg shadow-md py-2.5 font-medium flex items-center justify-center gap-2",
  secondaryButton: "w-full bg-gray-100 text-gray-700 hover:bg-gray-200 active:bg-gray-300 transition-all duration-200 rounded-lg shadow-sm py-2.5 font-medium flex items-center justify-center gap-2",
  dangerButton: "flex items-center gap-2 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 active:bg-red-700 transition-all duration-200 transform hover:-translate-y-1",
  successButton: "flex items-center justify-center gap-2 px-6 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:from-green-600 hover:to-emerald-700 active:from-green-700 active:to-emerald-800 transition-all duration-200 transform hover:-translate-y-1 shadow-md font-medium min-w-[120px]",
